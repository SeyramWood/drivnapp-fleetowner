...
import 'package:drivn/features/owner/domain/entities/vehicle.model.dart'as model;

import '../../../../shared/errors/failure.dart';
import '../entities/v.request.model.dart';

abstract class OwnerRepo{
  Future<Either<Failure,String?>> addVehicle(model.VehicleToDBModel vehicle);
  Future<Either<Failure,List<model.Vehicle>>> fetchVehicles(String userID);
  Future<Either<Failure,List<BookedVehicle>>> fetchBookedVehicles(String userID);
  Future<Either<Failure,void>> updateRental(String vehicleID,UpdateRentalModel updateRentalModel);

  Future<Either<Failure,void>> updateAvailability(String vehicleID,String status);
